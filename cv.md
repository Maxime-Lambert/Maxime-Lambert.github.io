...
[➡️ **Télécharger mon CV (PDF)**](/Assets/Lambert_Maxime_CV.pdf){: .btn .btn--primary}
...
### Ingénieur d’Études et Développement – Sopra Steria
...
- Maintenance de l’application à travers l’analyse de trames d’erreurs et le développement des correctifs nécessaires.
...
### Stage Analyste Développeur – Atos
...
- Conception et développement d’une **SPA** avec **React** & **Typescript**.  
- Système d'authentification pour sauvegarder l'historique et les paramètres avec **ASP .Net Core Identity** & **JWT Tokens**.
- Intégration continue avec **GitHub Actions** et **XUnit** (tests unitaires, intégration, fonctionnels).  
- Déploiement continu avec **GitHub Actions** sur **Azure**.

**Technologies :**  
*C#, React, Typescript, ASP.NET Core Web API, EFCore, PostgreSQL, SwaggerUI, Docker, Azure, xUnit, ASP.Net Core Identity, JWT Tokens, Axios, Shadcn, GitHub, Clean Architecture.*
...
- Conception et développement d’une **API REST** avec **C#** & **.NET**.  
- Conception et développement d’une **SPA** avec **React** & **Typescript**.  
- Rédaction d’un document technique (README) présentant l’architecture.  
- Intégration continue avec **GitHub Actions** et XUnit (tests unitaires, intégration, fonctionnels).  
- Déploiement continu avec **GitHub Actions** sur **Azure**.
